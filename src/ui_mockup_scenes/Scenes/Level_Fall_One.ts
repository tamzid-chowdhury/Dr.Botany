...
export default class Level_Fall_One extends GameLevel {
    ...
    loadScene(): void {
        super.loadScene();
        this.load.tilemap("level_fall_one", "assets/tilemaps/FallLevel/level_fall_one.json"); // this change
    ...
    startScene(): void {
        ...
        this.enemyManager = new EnemyManager(this, this.tilemapSize, [0,2,6,6,1]);
