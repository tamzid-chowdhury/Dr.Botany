...
export default class Level_Winter_Two extends GameLevel {
    ...
    loadScene(): void {
        super.loadScene();
        this.load.tilemap("level_fall_two", "assets/tilemaps/WinterLevel/level_winter_two.json"); // this change
    ...
    startScene(): void {
        ...
        this.enemyManager = new EnemyManager(this, this.viewport.getHalfSize(), [10,10,10,10,10]);
        ...
        let newVec = new Vec2(1000, 990);
		super.initPlayer(newVec);
